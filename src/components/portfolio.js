    ...
    return (
        ...
        <div class="App">
                ...
                <table>
                    <tr>
                        <td><h3 class="i1">Hi,</h3>
                            <h3 class="i1">I am Aditya Vardhan</h3>
            ...
            <div ref={projects} class="projects">
                ...
                <h4>➢ Smart pill box using Rasberry pi pico</h4>
                <h4>➢ Object detection using Arduino.</h4>
            </div>
            <div ref={contact} class="contact">
                <h3 class="heading">Contact Details</h3>
                <h4>Email : adityavardhan.koya@gmail.com</h4>
                <h4>Contact Number : 8885559829</h4>
                <h4>My GitHub link <a href="https://github.com/AdityavardhanKoya">It's here</a></h4>
                <h4>Instagram Id : @adityavardhan </h4>
            </div>
        </div>
    )
}